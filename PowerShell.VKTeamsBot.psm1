class VKTeamsBot {
	...
	[PSCustomObject] SendVoiceByPath (
		[string] $chatId,
		[System.IO.FileInfo] $FilePath, 
		[string] $caption = $null
	){
	...
	[PSCustomObject] AnswerCallbackQuery (
		[string] $queryId, 
		[string] $text,
		[boolean] $showAlert,
		[string] $url
	...
	[PSCustomObject] SendChatActions (
		[string] $chatId, 
		[string[]] $actions
	){
		$Parameters = [System.Web.HttpUtility]::ParseQueryString([String]::Empty)
	...
	[PSCustomObject] GetChatBlockedUsers (
		[string] $chatId
	){
		$Parameters = [System.Web.HttpUtility]::ParseQueryString([String]::Empty)
		$Parameters['token'] = $this.TOKEN
	...
	[PSCustomObject] GetChatPendingUsers (
		[string] $chatId
	){
		$Parameters = [System.Web.HttpUtility]::ParseQueryString([String]::Empty)
		$Parameters['token'] = $this.TOKEN
	...
	[PSCustomObject] UnblockChatUser (
		[string] $chatId,
		[string] $userId
	){
		$Parameters = [System.Web.HttpUtility]::ParseQueryString([String]::Empty)
	...
	[PSCustomObject] ResolvePendingChatUsers (
		[string] $chatId, 
		[boolean] $approve,
		[string] $userId,
		[boolean] $everyone
	...
	[PSCustomObject] UnpinChatMessage (
		[string] $chatId, 
		[string] $msgId
	){
		$Parameters = [System.Web.HttpUtility]::ParseQueryString([String]::Empty)
